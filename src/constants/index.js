...
export const HERO_CONTENT = `I'm a full stack developer with a passion for building dynamic and responsive web applications. I work with front-end and back-end technologies like React.js,.NET, MySQL, MSSQL.`;
...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: project4,
    description:
      "  This is a group project which is a system that allows users to send and receive messages to and from other users. These systems can take various forms, including email platforms, chat applications, social media platforms, and even SMS messages",
    technologies: ["HTML", "CSS", "JavaScript", "PHP", "MySQL"],
  },
];

export const CONTACT = {
  address: "Hambanthota District, Sri Lanka ",
