import profilePic from "../assets/ishiniProfile.jpg"
    ...
    <div className="pb-4 lg:mb-36">
      <div className="flex flex-wrap lg:flex-row-reverse">
        <div className="w-full lg:w-1/2">
         ...
         <motion.img src={profilePic} alt="Profile picture"  className="border border-stone-900 rounded-3xl"
         width={650}
         height={650}
        ...
        <div className="w-full lg:w-1/2">
            ...
            variants={containerVariants}
             className="flex flex-col items-center lg:items-start mt-10">
                ...
                className="pb-2 text-4xl tracking-tighter lg:text-8xl"> Ishini Wickramage </motion.h2>
                <motion.span 
                variants={childVariants}
